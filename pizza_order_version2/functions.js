...
function statingProgram (user.input){
    user.input = downcase
    if user.input === yes or y 
        continue 
    elsif user.input === no or n 
        console.log ("Have a nice day")
        break
    else 
        console.log ("Please try again and remember to continue to your order press Y or to quit the program press N")
};
